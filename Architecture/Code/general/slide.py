...
import pygame
import time
from constants import KEY_MAPPINGS, WIDTH, HEIGHT, BG_COLOR, FREQS, TEXT_COLOR
...
class SlidePlayGame:
    ...
    def run_pre_play(self):
        ...
        self.screen.blit(ready_text, (WIDTH//2 - ready_text.get_width()//2, HEIGHT//2))
        
        start_text = self.small_font.render("Press SPACE to start", True, (200, 200, 200))
        self.screen.blit(start_text, (WIDTH//2 - start_text.get_width()//2, HEIGHT//2 + 40))
