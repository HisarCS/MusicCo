...
def draw_note_ribbon(creator):
    ...
    for note in sorted_notes:
        ...
        # Draw note rectangle
        color = creator.note_colors[note['Note']]
...
def draw_state_info(creator):
    ...
    if creator.state == NOTE_SELECTION:
        ...
        creator.screen.blit(octave_text, (WIDTH//2 - 150, 60))
...
def draw_controls_guide(creator):
    ...
    controls_text = creator.small_font.render(
        "BACKSPACE: Cancel/Delete last note | CTRL+S: Save | ESC: Exit", 
        True, (200, 200, 200)
    )
