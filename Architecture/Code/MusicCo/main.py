# main.py - Main entry point for the music application with Learn/Create/Connect selection

import pygame
import sys
from learn import main as learn_main
from music_creation import MusicCreator
from Co import MusicConnection
...
def main():
    ...
    selected_button = 0  # 0 for Learn, 1 for Create, 2 for Connect
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_a:
                    selected_button = (selected_button + 1) % 3  # Cycle between 0, 1, and 2
        ...
        connect_button_rect = draw_button(
            screen, "Connect", 
            (WIDTH - WIDTH//4 - 100, HEIGHT//2 - 40), 
            (200, 80), 
            BUTTON_COLOR if selected_button != 2 else BUTTON_SELECTED_COLOR, 
            TEXT_COLOR,
            button_font,
            selected_button == 2
        )
